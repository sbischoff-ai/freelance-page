<i18n>
{
    "en": {
        "person": "Person",
        "personalinfo": "Hello, my name is Silas Bischoff. I'm a freelance software developer and data scientist. The things I could do for you include, for example:<br><br><ul><li>A professional analysis of your business segments or customer base,</li> <li>the complete development of a data-driven application from conception to integration,</li> <li>or simply full-stack support as a member of your development team.</li></ul>",
